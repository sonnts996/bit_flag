...
mixin class BitFlag implements IBitFlag {
  ...
  /// The [value] is a decimal integer with numbers that only accept 0 and 1.
  ///
  /// Example:
  ///
  ...
  /// Create a [FlipBitFlag] with the [otherSide]
  const factory BitFlag.not(IBitFlag otherSide) = _FlipBitFlag;

  ///  Create a [FlipBitFlag] with the [otherSide]'s value.
